var basePath="/static/plugin/superui-master"
var ModuleMgr = function () {
    ...
    exports.loadTree = function () {
        ...
        var item = {
            ...
            url: basePath+"/content/supermgr/json/ModuleTree.json",
    ...
    exports.loadGrid = function () {
        ...
        exports.options.$gridTable.jqGrid({
            datatype: "json",
            url: basePath+"/content/supermgr/json/ModuleGrid.json",
   ...
   exports.btnDelete= function () {
       var keyValue = $("#gridTable").jqGridRowValue("Id");
        if (keyValue) {
            $.fn.deleteForm({
                url: basePath+"/SysMgr/ModuleMgr/RemoveForm",
    ...
    exports.btnEdit=function() {
        ...
        if (checkedRow(keyValue)) {
            $.fn.modalOpen({
                id: "Form",
                title: '编辑功能',
                url: basePath+'/pages/supermgr/ModuleForm.html?keyValue=' + keyValue,
                width: "700px",
                height: "430px",
                btn: null
    ...
    exports.btnAdd = function() {
        ...
        $.fn.modalOpen({
            id: "Form",
            title: '添加功能',
            url: basePath+'/pages/supermgr/ModuleForm.html?parentId=' + exports.options.ParentId,
            btn: null,
            width: "700px",
            height: "430px"
    ...
    exports.btnModuleSelectIcon = function () {
        ...
        $.fn.modalOpen({
            id: "SelectIcon",
            title: '选取图标',
            url: basePath+'/SysMgr/ModuleMgr/SelectIcon?ControlId=Icon',
            width: "1000px",
            height: "600px",
            btn: false,
    ...
    exports.initFormControl = function (readonly) {
        ...
        if (!!exports.options.KeyValue) {
            $.fn.setForm({
                url: basePath+"/content/supermgr/json/ModuleFrom.json",
    ...
    exports.acceptClick = function () {
      ...
      //  postData["moduleColumnListJson"] = JSON.stringify(exports.options.ColumnJson);
        $.fn.submitForm({
            url: basePath+"/SysMgr/ModuleMgr/SaveForm?keyValue=" + exports.options.KeyValue,
            param: postData,
            loading: "正在保存数据...",
            success: function() {
    ...
    exports.getButtonGrid = function () {
        ...
        $.ajax({
            url: basePath+"/content/supermgr/json/ModuleButtonList.json?moduleId=" + escape(moduleId),
            type: "get",
            dataType: "json",
            success: function (data) {
        ...
        exports.options.$buttonGrid.jqGrid({
            unwritten: false,
            url: basePath+"/content/supermgr/json/ModuleButtonTree.json?moduleId=" + escape(moduleId),
            datatype: "json",
    ...
    exports.btnModuleBtnAdd=function() {
        ...
        $.fn.modalOpen({
            id: "buttonForm",
            title: '添加按钮',
            url: basePath+'/SysMgr/ModuleMgr/ButtonForm?parentId=' + parentId + "&moduleId=" + escape(exports.options.ModuleId),
            width: "450px",
            height: "300px",
    ...
    exports.btnModuleBtnEdit=function() {
        ...
        if (checkedRow(moduleButtonId)) {
            $.fn.modalOpen({
                id: "buttonForm",
                title: '编辑按钮',
                url: basePath+'/SysMgr/ModuleMgr/ButtonForm?moduleButtonId=' + moduleButtonId + "&moduleId=" + +escape(exports.options.ModuleId),
                width: "450px",
                height: "300px",
                callBack: function (iframeId) {
                    top.frames[iframeId].buttonAcceptClick(function (data) {
    ...
    exports.btnModuleBtnCopy=function() {
        ...
        if (checkedRow(moduleButtonId)) {
            $.fn.modalOpen({
                id: "OptionModule",
                title: '将按钮复制到指定功能里面',
                url: basePath+'/SysMgr/ModuleMgr/ButtonOptionModule?keyValue=' + moduleButtonId,
                width: "500px",
                height: "500px",
                callBack: function (iframeId) {
    ...
    exports.buttonListToListTreeJson= function (buttonJson) {
        $.ajax({
            url: basePath+"/SysMgr/ModuleMgr/ModuleButtonListToListTreeJson",
    ...
    exports.buttonInitControl = function () {
        ...
        //上级
        $("#ParentId").ComboBoxTree({
            url: basePath+"/content/supermgr/json/ModuleButtonList.json",
