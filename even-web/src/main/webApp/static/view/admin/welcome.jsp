...
<head>
    ...
    <!-- Morris -->
    <link href="/static/plugin/hplus/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="/static/plugin/hplus/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="/static/plugin/hplus/js/plugins/flot/jquery.flot.js"></script>
    <script src="/static/plugin/hplus/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/static/plugin/hplus/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/static/plugin/hplus/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/static/plugin/hplus/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/static/plugin/hplus/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/static/plugin/hplus/js/demo/peity-demo.min.js"></script>
    <script src="/static/plugin/hplus/js/content.min.js?v=1.0.0"></script>
    <script src="/static/plugin/hplus/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="/static/plugin/hplus/js/plugins/gritter/jquery.gritter.min.js"></script>
    <script src="/static/plugin/hplus/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="/static/plugin/hplus/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="/static/plugin/hplus/js/demo/sparkline-demo.min.js"></script>
    <script>
