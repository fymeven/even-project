...
<head>
    ...
    <link href="/static/plugin/superui-master/content/supermgr/Base/css/common.css" rel="stylesheet"/>
    <link href="/static/plugin/superui-master/content/plugins/jqgrid/jqgrid.css" rel="stylesheet"/>


    <script src="/static/plugin/superui-master/content/plugins/datepicker/WdatePicker.js"></script>

    <link href="/static/plugin/superui-master/content/plugins/wdtree/tree.css" rel="stylesheet"/>
    <style>
        html,body {
            overflow: hidden;
        }
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">系统模块管理</a></li>
    </ol>
</section>
<!-- Main content -->
...
<script src="/static/plugin/superui-master/content/ui/global/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
...
<script src="/static/plugin/superui-master/content/plugins/jqgrid/grid.locale-cn.js"></script>
<script src="/static/plugin/superui-master/content/plugins/jqgrid/jqgrid.js"></script>
<script src="/static/plugin/superui-master/content/supermgr/Base/js/common.js"></script>

<script src="/static/plugin/superui-master/content/plugins/validator/validator.js"></script>
<script src="/static/plugin/superui-master/content/plugins/layout/jquery.layout.js"></script>

<script src="/static/plugin/superui-master/content/plugins/wdtree/tree.js"></script>
<script src="/static/plugin/superui-master/content/supermgr/Module/ModuleMgr/ModuleMgr.js"></script>
