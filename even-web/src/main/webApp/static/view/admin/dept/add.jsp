...
<form class="form-horizontal m-t" novalidate="novalidate" action="/department/save">
<div class="form-group">
<label class="col-sm-3 control-label">部门名称：</label>
<div class="col-sm-8">
<input id="deptName" name="deptName" class="form-control" type="text" autocomplete="off">
</div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-8">
        ...
        <input id="parentName" name="parentName" class="form-control" type="text" autocomplete="off" disabled value="${parent.deptName}">
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" class="form-control" id="deptManagerId" name="deptManagerId" autocomplete="off">
...
<script src="/static/js/admin/dept/add.js"></script>
</body>
</html>
