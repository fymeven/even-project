...
<form class="form-horizontal m-t" id="form_role_add" novalidate="novalidate">
...
<div class="col-sm-8">
<input id="roleStatus" name="roleStatus" class="form-control" type="checkbox" checked autocomplete="off">
</div>
</div>
<div class="form-group">
