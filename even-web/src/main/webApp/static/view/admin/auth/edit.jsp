...
<div class="wrapper wrapper-content  animated fadeInRight">
    <form class="form-horizontal m-t" novalidate="novalidate" action="/sysAuth/edit">
        <input type="hidden" id="id" name="id" value="${detail.id}">
        <div class="form-group">
            <label class="col-sm-3 control-label">权限名称：</label>
            <div class="col-sm-8">
                <input id="authName" name="authName" class="form-control" type="text" autocomplete="off" value="${detail.authName}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="perms" name="perms" class="form-control" type="text" autocomplete="off" value="${detail.perms}">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">图标：</label>
            <div class="col-sm-8">
                <input id="icon" name="icon" class="form-control" type="text" autocomplete="off" value="${detail.icon}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="radio radio-success radio-inline">
                    <input type="radio" id="type1" value="1" name="type" disabled <c:if test="${detail.type == 1}">checked</c:if>>
                    <label for="type1"> 目录 </label>
                </div>
                <div class="radio radio-primary radio-inline">
                    <input type="radio" id="type2" value="2" name="type" disabled <c:if test="${detail.type == 2}">checked</c:if>>
                    <label for="type2"> 菜单 </label>
                </div>
                <div class="radio radio-warning radio-inline">
                    <input type="radio" id="type3" value="3" name="type" disabled <c:if test="${detail.type == 3}">checked</c:if>>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="linkUrl" name="linkUrl" class="form-control" type="text" autocomplete="off" <c:if test="${detail.type != 2}">disabled</c:if> value="${detail.linkUrl}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <textarea id="authDesc" name="authDesc" class="form-control" autocomplete="off">${detail.authDesc}</textarea>
            </div>
        </div>
        <div class="form-group">
...
<script src="/static/js/admin/auth/edit.js"></script>
</body>
</html>
