...
<head>
    ...
    <link rel="stylesheet" href="/static/plugin/superui-master//content/adminlte/dist/css/skins/_all-skins.css">
            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="/static/plugin/superui-master/content/ui/img/photos/girl1.png" class="img-circle" alt="User Image">
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="/static/plugin/superui-master/content/ui/img/photos/girl1.png" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="/static/plugin/superui-master/content/ui/img/photos/girl1.png" class="img-circle" alt="用户头像">
            </div>
...
<script type="text/javascript">
    $(function() {
        addTabs(({ id: '10008', title: '欢迎页', close: false, url: '/static/plugin/superui-master/admin/dashboard.html' }));
        App.fixIframeCotent();
        $.ajax({
            url:'/system/initSysMenu',
            type:'get',
            success:function(result){
                if(result.status){
                    $('.sidebar-menu').sidebarMenu({ data: result.data, param: { strUser: 'admin' } });
                    //处理菜单ajax方式加载
                    App.handleSidebarAjaxContent();
                }else{
                    layer.msg(result.msg,2,"提示");
                }
            }
        });
