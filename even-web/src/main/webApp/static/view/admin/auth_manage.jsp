...
<body class="gray-bg" onload="auth.init()">
...
<div class="layout-right">
    ...
    <div class="btn-group-toolbar">
        <div class="btn-group">
            <a class="btn btn-default" id="btn_flush"><i class="fa fa-refresh"></i>&nbsp;刷新</a>
            <a class="btn btn-default" id="btn_add"><i class="fa fa-plus"></i>&nbsp;新增</a>
            <a class="btn btn-default" id="btn_edit"><i class="fa fa-pencil-square-o"></i>&nbsp;编辑</a>
            <a class="btn btn-default" id="btn_delete"><i class="fa fa-trash-o"></i>&nbsp;删除</a>
        </div>
    </div>
    <div>
